...
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96m-Kurosawa-\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;92m..........................KurosawaDiaresco......................
\033[1;93m
\033[1;93m   _  __  _   _   ____     ___    ____       _     __        __     _
| |/ / | | | | |  _ \   / _ \  / ___|     / \    \ \      / /    / \
| ' /  | | | | | |_) | | | | | \___ \    / _ \    \ \ /\ / /    / _ \
| . \  | |_| | |  _ <  | |_| |  ___) |  / ___ \    \ V  V /    / ___ \
|_|\_\  \___/  |_| \_\  \___/  |____/  /_/   \_\    \_/\_/    /_/   \_\
\033[1;93m 
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mKurosawa\033[1;95m♡╰──────────•◈•──────────╯♡"""
...
print  """
  \033[1;96m-┈┈┈┈┈┈┈┈┈┈          Kurosawa 
     _  __  _   _   ____     ___    ____       _     __        __     _
| |/ / | | | | |  _ \   / _ \  / ___|     / \    \ \      / /    / \
| ' /  | | | | | |_) | | | | | \___ \    / _ \    \ \ /\ / /    / _ \
| . \  | |_| | |  _ <  | |_| |  ___) |  / ___ \    \ V  V /    / ___ \
|_|\_\  \___/  |_| \_\  \___/  |____/  /_/   \_\    \_/\_/    /_/   \_\
...
* ¸¸¸¸*__________________________* ¸¸¸¸*«┈┈┈┈┈┈┈┈┈         
 ...
 \033[1;96m 
  \033[1;96m 
   \033[1;92m███████▒▒Welcome To KurosawaHacker▒▒████████
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96mKurosawaHacker\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;94mAuthor\033[1;91m: \033[1;91mKurosawaHacker
\033[1;94mBlackMafia\033[1;91m: \033[1;91▒▓██████████████]100.%
\033[1;94mFacebook\033[1;91m: \033[1;91mKurosawaHacker
\033[1;94mWhatsapp\033[1;91m: \033[1;91m+639631724392
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Kurosawa
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;91mWrong Password"
            os.system('xdg-open https://www.facebook.com/kurosawa.diaresco.1')
    else:
...
def menu():
	...
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mKurosawa\033[1;95m♡──────────•◈•──────────♡"
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mKurosawaHacker96mKurosawaHacker\033\033[1;95m♡──────────•◈•──────────♡"
		...
		print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mKurosawaHacker\033[1;95m♡──────────•◈•──────────╯♡"
		try:
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mKurosawaDiaresco\033[1;95m♡──────────•◈•──────────♡"
	print "  \033[1;93m«---•◈•---Developed By Kurosawa---•◈•---»" #KurosawaLangMalakas
	print '\033[1;91mProcess Has Been Completed\033[1;92m....'
	print"\033[1;91mTotal OK/\x1b[1;93mCP \033[1;91m: \033[1;91m"+str(len(oks))+"\033[1;97m/\033[1;95m"+str(len(cekpoint))
	print """
             
♡──────────────•◈•──────────────♡.
: \033[1;96m .....KurosawaHacker KurosawaHacker........... \033[1;93m :
♡──────────────•◈•──────────────♡.' 
                Phone number
               +639631724392"""
